...
def extract_place_info(caption: str, transcript: str) -> Optional[ExtractedPlace]:
    """
    ...
    system_prompt = (
        ...
        "2. If a field is not present, output null for it.\n"
        "3. The 'category' must be exactly one of: 'food', 'attraction', 'store', 'event', 'other'.\n"
        "4. The 'confidence' score must be a float between 0.0 and 1.0 representing your genuine estimate of how accurate this extraction is based on the provided text, and it must come from your own analysis, do not assume it's always 1.0.\n"
    ...
    try:
        ...
        try:
            ...
            return ExtractedPlace(**data_retry)
